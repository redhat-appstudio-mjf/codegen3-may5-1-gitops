...
# Application
An application built from https://github.com/redhat-appstudio-mjf/codegen3-may5-1 will be stored in [quay.io/maysunfaisal/codegen3-may5-1](https://quay.io/maysunfaisal/codegen3-may5-1) and deployed through GitOps. This application is accessible on port **8501**.